...
public class PopUpInformation extends Stage {
    ...
    public PopUpInformation (Skin skin) {
        ...
        table.add(img_ressource.get(Square.eType.Thystame)).left().bottom().expand().padBottom(15).padLeft(5);
        table.add(labelInfo.get(Square.eType.Thystame)).left().bottom().expand();
        table.add(img_ressource.get(Square.eType.Sibur)).left().bottom().expand().padBottom(15);
        table.add(labelInfo.get(Square.eType.Sibur)).left().bottom().expand();
        table.row();
        table.add(img_ressource.get(Square.eType.Phiras)).left().bottom().expand().padBottom(15).padLeft(5);
        table.add(labelInfo.get(Square.eType.Phiras)).left().bottom().expand();
        table.add(img_ressource.get(Square.eType.Mendiane)).left().bottom().expand().padBottom(15);
        table.add(labelInfo.get(Square.eType.Mendiane)).left().bottom().expand();
        table.row();
        table.add(img_ressource.get(Square.eType.Linemate)).left().bottom().expand().padBottom(15).padLeft(5);
        table.add(labelInfo.get(Square.eType.Linemate)).left().bottom().expand();
        table.add(img_ressource.get(Square.eType.Deraumere)).left().bottom().expand().padBottom(15);
        table.add(labelInfo.get(Square.eType.Deraumere)).left().bottom().expand();
        table.row();
        table.add(img_ressource.get(Square.eType.Nourriture)).left().bottom().expand().padBottom(15).padLeft(5);
        table.add(labelInfo.get(Square.eType.Nourriture)).left().bottom().expand();
